...
def edit_extract(yamldata):    # edits extract/Extract.py
    ...
    g.write("tphase = False# make 3pt odd t -ve\n")
    g.write("##########################################\n")
    g.write("\n")
    g.write("\n")
    g.write("\n")
    ...
    if 'parent prop' in yamldata:
        ...
        g.write("                            average_imaginary(filenames,datatag,g,neg)\n")
        g.write("                        else:\n")
        g.write("                            average(filenames,datatag,g,neg)\n")        
    if 'daughter prop' in yamldata:
    ...
    if yamldata['lattice info']['justtwopoints'] == False:
        for threeptlabel in yamldata['three points']['label']:
            ...
            g.write("                            if '{0}' in imaginary:\n".format(threeptlabel))
            g.write("                                average_imaginary(filenames,datatag,g,neg,2)\n")
            g.write("                            else:\n")
            g.write("                                average(filenames,datatag,g,neg,2)\n") 
    ...
    g.write("\n")
    g.write("\n")
    g.write("def average(filenames,datatag,g,neg,fac=1):\n")
    ...
    g.write("\n")
    g.write("\n")
    g.write("def average_imaginary(filenames,datatag,g,neg,fac=1):\n")
    g.write("    result = collections.OrderedDict()   \n")
    g.write("    for filename in filenames:                          #filenames is list of files to be averaged\n")
    g.write("        result[filename] = []\n")
    g.write("        if os.path.exists(filename):\n")
