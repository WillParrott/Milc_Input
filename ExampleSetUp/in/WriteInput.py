...
def edit_extract(yamldata):    # edits extract/Extract.py
    ...
    g.write("        src = filename.split('_t')[1].split('_')[0]\n")
    ...
    g.write("                result[filename].append('-{0}'.format(lines[j].split()[1]))\n")
    g.write("            else:\n")
    ...
    g.write("        for j in range(lastdots+1,lastdots+1+nt):\n")
    g.write("            if tag in tneg and src%2 == 1:\n")
    g.write("                result[filename].append('-{0}'.format(lines[j].split()[2]))\n")
    g.write("            else:\n")
